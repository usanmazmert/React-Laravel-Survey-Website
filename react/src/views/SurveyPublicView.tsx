...
import { Question } from "./SurveyView";

export default function SurveyPublicView() {
  const answers = {} as any;
  const [surveyFinished, setSurveyFinished] = useState(false);
  const [survey, setSurvey] : [any, any] = useState({
  ...
  function answerChanged(question : Question, value : any) {
              ...
              <div>
                {survey.questions.map((question : any, index : any) => (
                  <PublicQuestionView
                    ...
                    question={question}
                    index={index}
                    answerChanged={(val : any) => answerChanged(question, val)}
                  />
                ))}
              </div>
              <button
