...
export type Question = {
      ...
      question: string,
      description: string,
      data: {options?: { uuid: string, text: string }[]},
}
...
const SurveyView = (props: Props) => {
  ...
  const onImageChoose = (ev : React.ChangeEvent<HTMLInputElement> ) => {
    ...
    reader.onload = () => {
      setSurvey({
        ...survey,
        image: file as File | any,
        image_url: reader.result as string | any,
      });
        ...
        <form action="#" method="POST" onSubmit={onSubmit}>
          <div className="shadow sm:overflow-hidden sm:rounded-md">
            ...
            <div className="bg-gray-50 px-4 py-3 text-right sm:px-6">
              <button type='submit' className='bg-indigo-500 py-2 px-3 text-xl float-left mb-2 rounded-md text-white'>Save</button>
            </div>
        </form>)}
    </PageComponent>
  );
