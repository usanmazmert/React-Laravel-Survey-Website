...
type Context = {
  currentUser : string,
  userToken: string,
  setCurrentUser: (userData : {name: string, email: string, imageUrl: string}) => React.Dispatch<React.SetStateAction<string>>
}

export const StateContext = createContext({
currentUser: { name: "", email: "", imageUrl: "" } as {name?: string, email?: string, imageUrl?: string},
  userToken: "",
...
export const ContextProvider = ({ children }: Props) => {
  ...
  const storeUserToken = (token : string) : void => {
    if(token)
    {
  ...
  return (
    <StateContext.Provider
      value={{ currentUser, setCurrentUser, userToken, setUserToken, surveys, storeUserToken, questionTypes, toast, showToast }}
    >
      {children}
    </StateContext.Provider>
  );
